...
#ifndef INCLUDE_RESTCLIENT_CPP_VERSION_H__
#define INCLUDE_RESTCLIENT_CPP_VERSION_H__
#define RESTCLIENT_VERSION "5655b4e-dirty"
#endif  // INCLUDE_RESTCLIENT_CPP_VERSION_H__
